...
def plot_with_sliders():
    ...
    for i, cond in enumerate(conditions):
        for j in range(1, 6):  # Replicates 1 to 5
            ...
            model_lines.append({'line': line, 'ax': ax, 'i': i, 'j': j-1, 'r2_text': r2_text})
            ...
            if i == 4:
                ax.set_title(f'$C_0 \\times {s0_factors[j]:.3f}$', fontsize=10, fontweight='bold')
    ...
    def update(val):
        ...
        for ml in model_lines:
            ...
            try:
                ...
                print(f"Error for condition L0={conditions[i]['L0']}, C0={s0_factors[j+1]:.3f}: {e}")
