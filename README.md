...
- `DMB_sliders.py` generates the visual adjustment of Droop model from [Martínez et al. 2020] on *C.reinhardtii* flask and microplate cultures data,
...
- `LMMB_sliders.py` generates the visual adjustment of LMMB model from [Kambe et al. 2022] on *C.reinhardtii* flask and microplate cultures data,
- `MMmB_sliders.py` generates the visual adjustment of MMmB model on *C.reinhardtii* flask and microplate cultures data. This model was introduced for this specific study and takes into account a death rate depending on light intensity. 
...
19(191):20220166, 2022. doi: https://doi.org/10.1098/rsif.2022.0166. URL https://royalsocietypublishing.org/doi/abs/10.1098/rsif.2022.0166.
